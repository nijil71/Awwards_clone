    ...
    <section className='bg-black pb-52'>
      <div className='container mx-auto px-3 md:px-10'>
        <div className="px-5 py-32">
            ...
            opacity-50
            '>
                Immerse Yourself in a rich and exclusive virtual world, where you can explore, create, and connect with others from around the world.
            </p>
        </div>
        ...
        md:h-[65vh]">
            ...
            title = {<>radi<b>n</b>t</>}
            description = "A new way to explore the metaverse. Interact with others from around the world."
            />
        </BentoTilt>
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
            ...
            <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
                ...
                title = {<>az<b>u</b>l</>}
                description = "A cross-world AI Agent - elevating your gameplay to be more fun and interactive."
                />
